...
- [2.6](#prefer-function-component) Предпочитайте использовать функциональные компоненты при создании новых компонентов и рефакторинге старых. 

  >Почему: Функциональные компоненты проще писать и читать, а также выходит меньше кода. Разработчики React утверждают, что в функциональных компонентах возросла производительность по сравнению с классовыми компонентами.
